...
namespace UI.Views.Menu
{
    public class MainMenuPage : Page
    {
        ...
        [SerializeField] private Button _comicButton;
        ...
        private void Start()
        {
            ...
            _comicButton.onClick.AddListener(OnComicButtonClicked);
        }
        ...
        private void OnComicButtonClicked()
        {
        ...
        private void OnDestroy()
        {
            ...
            _comicButton.onClick.RemoveListener(OnComicButtonClicked);
        }
    }
}